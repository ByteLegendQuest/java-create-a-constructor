...
`git clone https://github.com/ByteLegendQuest/java-create-a-constructor`

A project directory named `java-create-a-constructor` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-create-a-constructor` directory which is created just now.
